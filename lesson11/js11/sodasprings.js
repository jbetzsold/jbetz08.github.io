const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5607916&units=imperial&appid=f9d8b738eb9d7251e6d7f03f5ebb4c6d"
fetch(apiURL)
...
const forecastAPI = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&appid=35b4e0110586e378b3fe0f1a31249d84"
fetch(forecastAPI)
    .then((response) => response.json())
    .then((forecastObject) => {
